      ...
      <div className="page-container">
        ...
        <section className="about-section">
          <div className="about-content">
            <h2>About Us</h2>
            <p>
              We are a modern company dedicated to delivering top-notch solutions
              for businesses worldwide. Our mission is to empower our clients
              through seamless services, ensuring growth and innovation.
            </p>
