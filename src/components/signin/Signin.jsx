...
const Signin = () => {
  ...
  const handleResendOtp = async () => {
    setError(null);
    try {
      const response = await axios.post(`${API_BASE_URL}/resend-otp`, { email: formData.email });
      alert(response.data);
    } catch (error) {
      setError(error.response?.data || "Error resending OTP");
    }
  };
                ...
                {!otpSent ? (
                  ...
                  <form onSubmit={handleOtpSubmit}>
                    ...
                    <div className="signin-button-group">
                      <button type="submit" className="signin-btn signin-btn-blue">Verify OTP</button>
                      {/* Resend OTP Button */}
                      <button type="button" className="signin-btn resend-otp-btn" onClick={handleResendOtp}>
                        Resend OTP
                      </button>
                    </div>
                  </form>
